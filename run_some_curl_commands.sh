...
echo "curl -i -H "Content-Type: application/json" -X POST -d '["category3"]' http://localhost:5000/api/v1/category/"
curl -i -H "Content-Type: application/json" -X POST -d '["category100"]' http://localhost:5000/api/v1/categories

echo "curl -i -H "Content-Type: application/json" -X GET -d '{}' http://localhost:5000/api/v1/categories"
